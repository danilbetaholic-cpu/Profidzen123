...
// Пустой массив = показываются фирменные плейсхолдеры iBrain.
window.SHOP_INSTAGRAM = {
  url: "https://instagram.com/",   // ← ссылка на ваш Instagram
  reviews: "1 248 отзывов",        // подпись с количеством
  rating: "5.0",
  photos: [],                      // сюда позже добавите СВОИ фото-отзывы
  // Фирменные карточки-отзывы (на 100% ваши, без чужого контента).
  // Замените на реальные отзывы покупателей, когда появятся.
  cards: [
    { name: "Алексей М.", city: "Минск",      text: "Заказал iPhone 17 Pro, привезли в тот же день. Всё оригинальное, проверили серийник при мне. Рекомендую!" },
    { name: "Дарья К.",   city: "Гомель",      text: "Брала MacBook Air, помогли перенести данные со старого ноута. Очень довольна, спасибо за сервис." },
    { name: "Сергей П.",  city: "Минск",       text: "Купил Apple Watch Ultra, цена ниже чем у других, гарантия на месте. Доставка быстрая." },
    { name: "Ольга В.",   city: "Брест",       text: "Заказывала AirPods Pro, всё пришло в плёнке, чек и гарантия. Буду брать ещё." },
    { name: "Иван Т.",    city: "Витебск",     text: "Взял б/у iPhone 16 Pro как новый — реально без единой царапины, батарея 99%. Честный магазин." },
    { name: "Марина Л.",  city: "Минск",       text: "Понравилось, что всё прозрачно: цены, состояние, гарантия. Консультант ответил на все вопросы." }
  ]
};
...
// ---------- СТОКОВЫЕ ФОТО ПО КАТЕГОРИЯМ (Unsplash, бесплатно) ----------
// Используются в каталоге. Если появятся свои фото — добавьте товару поле
// photo:"img/...jpg", оно будет в приоритете. Если ссылка не откроется —
// показывается фирменная иллюстрация (без «битых» картинок).
// U() — Unsplash, P() — Pexels (оба бесплатны для коммерции).
// Несколько источников = если один не открылся, сайт пробует следующий.
const U = id => `https://images.unsplash.com/photo-${id}?w=600&q=80&auto=format&fit=crop`;
const P = (id,f) => `https://images.pexels.com/photos/${id}/${f}?auto=compress&cs=tinysrgb&w=600`;
window.CAT_PHOTOS = {
  iphone: [
    U("1592750475338-74b7b21085ab"), U("1605236453806-6ff36851218e"),
    U("1510557880182-3d4d3cba35a5"), U("1556656793-08538906a9f8"),
    P("404280","pexels-photo-404280.jpeg"), P("699122","pexels-photo-699122.jpeg")
  ],
  used: [
    U("1510557880182-3d4d3cba35a5"), U("1592750475338-74b7b21085ab"),
    P("47261","kettle-glass-jar.jpeg"), U("1556656793-08538906a9f8")
  ],
  ipad: [
    U("1544244015-0df4b3ffc6b0"), U("1561154464-82e9adf32764"),
    U("1557825835-70d97c4aa567"), P("1334597","pexels-photo-1334597.jpeg")
  ],
  mac: [
    U("1517336714731-489689fd1ca8"), U("1541807084-5c52b6b3adef"),
    U("1527443224154-c4a3942d3acf"), U("1611186871348-b1ce696e52c9"),
    P("18105","pexels-photo.jpg"), P("303383","pexels-photo-303383.jpeg")
  ],
  watch: [
    U("1546868871-7041f2a55e12"), U("1434493789847-2f02dc6ca35d"),
    U("1579586337278-3befd40fd17a"), P("437037","pexels-photo-437037.jpeg")
  ],
  audio: [
    U("1588423771073-b8903fbb85b5"), U("1606220588913-b3aacb4d2f37"),
    U("1505740420928-5e560c06d30e"), U("1572569511254-d8f925fe2cbb"),
    P("3825517","pexels-photo-3825517.jpeg")
  ],
  home: [
    U("1589003077984-894e133dabab"), U("1593784991095-a205069470b6"),
    U("1558089687-f282ffcbc126"), P("1279107","gray-and-black-laptop.jpeg")
  ],
  acc: [
    U("1583394838336-acd977736f90"), U("1572569511254-d8f925fe2cbb"),
    U("1600294037681-c80b4cb5b434"), P("4526407","pexels-photo-4526407.jpeg")
  ]
};
...
window.DEFAULT_PRODUCTS = [
  ...
  { id:110, cat:"used", name:"iPhone 12 Pro Max Dual SIM", price:1190, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone12-promax-blue-1.jpg","img/iphone12-promax-blue-2.jpg","img/iphone12-promax-blue-3.jpg","img/iphone12-promax-blue-4.jpg"],
  ...
  { id:118, cat:"used", name:"iPhone 15", price:990, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone15-black-1.jpg","img/iphone15-black-2.jpg","img/iphone15-black-3.jpg"],
  ...
  { id:119, cat:"used", name:"iPhone 15", price:990, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone15-blue-1.jpg","img/iphone15-blue-2.jpg","img/iphone15-blue-3.jpg"],
  ...
  { id:121, cat:"used", name:"iPhone 15", price:990, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone15-pink-1.jpg","img/iphone15-pink-2.jpg","img/iphone15-pink-3.jpg"],
  ...
  { id:125, cat:"used", name:"iPhone 14 Pro", price:1390, oldPrice:null, badge:"Как новый", stock:"out",
    ...
    colors:[["Silver","#e8e6e2"]],
    memory:[["256 ГБ",0]],
    photo:"img/iphone14-pro-silver-1.jpg",
    gallery:["img/iphone14-pro-silver-1.jpg","img/iphone14-pro-silver-2.jpg"],
  ...
  { id:124, cat:"used", name:"iPhone 14 Pro", price:1290, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone14-pro-black-1.jpg","img/iphone14-pro-black-2.jpg","img/iphone14-pro-black-3.jpg"],
  ...
  { id:123, cat:"used", name:"iPhone 14", price:790, oldPrice:null, badge:"Как новый", left:1,
    ...
    gallery:["img/iphone14-blue-1.jpg","img/iphone14-blue-2.jpg","img/iphone14-blue-3.jpg"],
