...
window.SHOP_CONFIG = {
  ...
  contacts: {
    ...
    phone: "+375291743684",            // для кнопки звонка
...
window.SHOP_INSTAGRAM = {
  ...
  cards: [
    { name: "Алексей М.", avatar: "img/review-avatar-1.jpg",  city: "Минск",     source: "site",      rating: 5,   text: "Заказал iPhone 17 Pro, привезли в тот же день. Всё оригинальное, проверили серийник при мне. Рекомендую!" },
    { name: "Дарья К.", avatar: "img/review-avatar-5.jpg",    city: "Гомель",    source: "instagram", rating: 4.5, text: "Брала MacBook Air, помогли перенести данные со старого ноута. Доставка чуть задержалась, но в целом довольна." },
    { name: "Сергей П.", avatar: "img/review-avatar-2.jpg",   city: "Минск",     source: "telegram",  rating: 5,   text: "Купил Apple Watch Ultra, цена ниже чем у других, гарантия на месте. Доставка быстрая." },
    { name: "Ольга В.", avatar: "img/review-avatar-6.jpg",    city: "Брест",     source: "site",      rating: 4.5, text: "Заказывала AirPods Pro, всё пришло в плёнке, чек и гарантия. Хотелось бы больше расцветок в наличии." },
    { name: "Иван Т.", avatar: "img/review-avatar-3.jpg",     city: "Витебск",   source: "instagram", rating: 5,   text: "Взял б/у iPhone 16 Pro как новый — реально без единой царапины, батарея 99%. Честный магазин." },
    { name: "Марина Л.", avatar: "img/review-avatar-7.jpg",   city: "Минск",     source: "telegram",  rating: 5,   text: "Понравилось, что всё прозрачно: цены, состояние, гарантия. Консультант ответил на все вопросы." },
    { name: "Дмитрий К.", avatar: "img/review-avatar-4.jpg",  city: "Гродно",    source: "site",      rating: 5,   text: "Долго выбирал, где брать iPhone 17. Здесь самая низкая цена и без всяких рассрочек. Привезли на следующий день." },
...
window.DEFAULT_PRODUCTS = [
  ...
  { id:2, cat:"iphone", name:"iPhone 17 Pro", price:2220, oldPrice:3171, badge:"Новинка",
    ...
    colors:[["Deep Blue","#1f2a44"],["Cosmic Orange","#e8762e"],["Silver","#d6dade"]],
  ...
  { id:3, cat:"iphone", name:"iPhone 17 Air", price:1810, oldPrice:2586, badge:"Самый тонкий",
    ...
    colors:[["Cloud White","#eceae6"],["Sky Blue","#b8d3e8"],["Light Gold","#e6d8b8"],["Space Black","#2a2c31"]],
    memory:[["256 ГБ",0],["512 ГБ",450],["1 ТБ",900]],
  ...
  { id:7, cat:"iphone", name:"iPhone 16 Pro", price:1950, oldPrice:2786, badge:null,
    ...
    img:"https://www.apple.com/newsroom/images/2024/09/apple-debuts-iphone-16-pro-and-iphone-16-pro-max/tile/Apple-iPhone-16-Pro-hero-240909-lp.jpg.og.jpg",
    gradient:["#bfa98a","#7a6a4f"], sim:true,
    colors:[["Black Titanium","#3a3c40"],["Desert Titanium","#bfa98a"],["Natural Titanium","#c2bcb2"],["Белый титан","#e8e6e2"]],
  ...
  { id:103, cat:"used", name:"iPhone 17 Pro Max (восст.)", photo:"img/iphone17-promax-new.jpg", price:1890, oldPrice:2700, badge:"Восстановленный",
    img:"https://www.apple.com/newsroom/images/2025/09/apple-unveils-iphone-17-pro-and-iphone-17-pro-max/article/Apple-iPhone-17-Pro-color-lineup-250909_inline.jpg.large.jpg",
  ...
  { id:110, cat:"used", name:"iPhone 12 Pro Max Dual SIM", price:1190, oldPrice:1700, badge:"Как новый", left:1,
  ...
  { id:122, cat:"used", name:"iPhone 15 Plus", price:1190, oldPrice:1700, badge:"Как новый", left:1,
    condition:"Как новый", gradient:["#1d1e22","#3a3c40"], sim:true,
  ...
  { id:107, cat:"used", name:"iPhone 15", photo:"img/iphone15-new.jpg", price:840, oldPrice:1200, badge:"Восстановленный",
    img:"https://www.apple.com/newsroom/images/2023/09/apple-debuts-iphone-15-and-iphone-15-plus/tile/Apple-iPhone-15-lineup-hero-230912.jpg.og.jpg",
  ...
  // ================= Б/У MAC =================
  { id:111, cat:"used", name:"MacBook Air 13 (M2)", price:1890, oldPrice:2700, badge:"Как новый",
  ...
  { id:127, cat:"used", name:"MacBook Pro 16″ (2021) M1 Pro", price:3290, oldPrice:4700, badge:"Как новый", left:1,
  ...
  { id:128, cat:"used", name:"MacBook Pro 16″ (2021) M1 Max", price:3990, oldPrice:5700, badge:"Как новый", left:1,
  ...
  { id:43, cat:"watch", name:"Apple Watch Ultra 3", price:2450, oldPrice:3500, badge:"Ultra",
  ...
  { id:61, cat:"home", name:"Apple Vision Pro", price:10500, oldPrice:15000, badge:"Будущее", stock:"soon",
    photo:"img/vision-pro-new.jpg",
  ...
  { id:62, cat:"home", name:"Apple TV 4K", price:560, oldPrice:800, badge:null,
  ...
  { id:63, cat:"home", name:"HomePod", price:840, oldPrice:1200, badge:null,
  ...
  { id:65, cat:"home", name:"AirTag", price:105, oldPrice:150, badge:"Новинка",
  ...
  // ================= АКСЕССУАРЫ =================
  { id:71, cat:"acc", name:"Чехол MagSafe для iPhone 17 Pro", photo:"img/acc-case-silicone-purple.jpg", price:105, oldPrice:150, badge:null,
    gradient:["#3d4356","#15171f"],
  ...
  { id:72, cat:"acc", name:"Зарядное устройство MagSafe", price:119, oldPrice:170, badge:null,
    gradient:["#e8ecf2","#aab4c4"],
  ...
  { id:79, cat:"acc", name:"Адаптер питания 67 Вт USB-C", price:119, oldPrice:170, badge:null,
    gradient:["#e8ecf2","#aab4c4"],
